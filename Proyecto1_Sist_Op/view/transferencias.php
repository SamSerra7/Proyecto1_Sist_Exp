...
<html lang="en">
    ...
    <!-- container -->
    <div class="container"> 
        <form method="post" action="../controller/insertTransfers.php" class="form-signin">
            <div class="panel panel-info" >
                <div class="panel panel-heading" align="center">
                    <h2 class="form-signin-heading">Realizar Transferencia</h2>
                    <hr/>
                </div>
                <div class="panel-body">
                    ...
                    ?>
                    <label >N&uacute;mero de cuenta a transferir</label>
                    <input type="number" id="t_account" name="t_account" class="form-control" placeholder="Nombre"  required/>
                    <label >Descripci&oacute;n</label>
                    <input type="text" id="desc" name="desc" class="form-control" placeholder="País de origen" required/>
                    <label  >Monto</label>
