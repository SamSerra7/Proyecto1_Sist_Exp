...
<html lang="en">
    ...
    <body class="bg-2">
        ...
        <nav class="navbar navbar-inverse">
          ...
          <div class="container">
            <div class="jumbotron">
                ...
                <h2>Digite el número de c&eacute;dula </h2>
                <br/>
                <form method="post" action="estadoCuenta.php" class="form-signin">
                <h3>
                    <input type="text" id="id" name="id"  class="form-control" placeholder="N&uacute;mero de c&eacute;dula" required/> 
                </h3>
                <br/>
                <h2>Digite el número de cuenta </h2>
                <br/>
                <form method="post" action="escogerDeposTransf.php" class="form-signin">
                <h3>
                    <input type="text" id="cuenta" name="cuenta"  class="form-control" placeholder="N&uacute;mero de c&eacute;dula" required/> 
                </h3>
                <br/>
                <br/>
                <h3>
        ...
        <?php
            ...
            require_once '../view/estadoCuenta.php';
