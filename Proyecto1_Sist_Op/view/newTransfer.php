    ...
    <body class="bg">
        ...
        <div class="container">
            <div class="jumbotron">
                ...
                <h2>Digite el número de c&eacute;dula de la persona que desea realizar la transferencia:</h2>
                <br/>
                <form method="post" action="transferencias.php" class="form-signin">
                <h3>
